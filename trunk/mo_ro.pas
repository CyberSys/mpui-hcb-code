...
begin
  with MainForm do begin
    LOCstr_Title:=UTF8Decode('MPlayer pentru Windows');
    ...
    MFile.Caption:=UTF8Decode('Fişier');
      ...
      MOpenDrive.Caption:=UTF8Decode('Redă CD/DVD');
...
'7/8'^I'Ajustează saturaţia'
  ...
  AboutForm.Caption:=UTF8Decode('Despre MPUI');
  AboutForm.BClose.Caption:=UTF8Decode('Închide');
  AboutForm.LVersionMPUI.Caption:=UTF8Decode('Versiunea MPUI:');
