...
begin
  with MainForm do begin
    LOCstr_Title:=UTF8Decode('MPlayer para Windows');
    ...
    MFile.Caption:=UTF8Decode('Archivo');
      ...
      MOpenURL.Caption:=UTF8Decode('Reproducir URL ...');
        ...
        LOCstr_OpenURL_Prompt:=UTF8Decode(''+
'Cuál es el URL a reproducir?');
      MOpenDrive.Caption:=UTF8Decode('Reproducir CD/DVD');
    ...
    MExtra.Caption:=UTF8Decode('Preferencias');
      ...
      MAspect.Caption:=UTF8Decode('Formato de imagen');
...
'7/8'^I'Ajustar saturación')
  ...
  AboutForm.Caption:=UTF8Decode('Acerca de MPUI');
  AboutForm.BClose.Caption:=UTF8Decode('Cerrar');
  AboutForm.LVersionMPUI.Caption:=UTF8Decode('Versión de MPUI:');
  ...
  with OptionsForm do begin
    ...
    LHelp.Caption:=UTF8Decode('Ayuda');
  end;
