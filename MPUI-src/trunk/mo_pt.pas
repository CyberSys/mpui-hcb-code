...
begin
  with MainForm do begin
    ...
    LEscape.Caption:=UTF8Decode('Pressione Esc para sair do modo de écran completo');
    MFile.Caption:=UTF8Decode('Ficheiro');
      ...
      MOpenDrive.Caption:=UTF8Decode('Reproduzir CD/DVD');
...
'7/8'^I'Ajustar saturação')
  ...
  AboutForm.Caption:=UTF8Decode('Sobre o MPUI');
  AboutForm.BClose.Caption:=UTF8Decode('Fechar');
  AboutForm.LVersionMPUI.Caption:=UTF8Decode('Versão do MPUI:');
  ...
  with OptionsForm do begin
    ...
    LHelp.Caption:=UTF8Decode('Ajuda');
  end;
