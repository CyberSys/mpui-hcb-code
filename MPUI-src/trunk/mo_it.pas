...
begin
  with MainForm do begin
    ...
    LEscape.Caption:=UTF8Decode('Premi ESC per uscire da tutto schermo.');
    MFile.Caption:=UTF8Decode('File');
      ...
      MOpenDrive.Caption:=UTF8Decode('Apri CD/DVD');
...
'7/8'^I'Aggiusta saturazione')
  ...
  AboutForm.Caption:=UTF8Decode('Circa MPUI');
  AboutForm.BClose.Caption:=UTF8Decode('Chiudi');
  AboutForm.LVersionMPUI.Caption:=UTF8Decode('Versione MPUI:');
  ...
  InfoForm.BClose.Caption:=UTF8Decode('Chiudi');
