...
begin
  with MainForm do begin
    LOCstr_Title:=UTF8Decode('MPlayer pour Windows');
...
'faud');
    ...
    MFile.Caption:=UTF8Decode('Fichier');
      ...
      MOpenDrive.Caption:=UTF8Decode('Jouer un CD/DVD');
    ...
    MExtra.Caption:=UTF8Decode('Préférences');
      ...
      MAspect.Caption:=UTF8Decode('Format de l''image');
...
'7/8'^I'Ajuster la saturation')
  ...
  AboutForm.Caption:=UTF8Decode('À propos de MPUI');
