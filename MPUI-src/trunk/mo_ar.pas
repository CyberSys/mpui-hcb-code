...
begin
  with MainForm do begin
    LOCstr_Title:=UTF8Decode('للويندوز MPlayer');
...
'7/8'^I'تعديل saturation')
  ...
  AboutForm.Caption:=UTF8Decode('عن MPUI');
  AboutForm.BClose.Caption:=UTF8Decode('غلق');
  AboutForm.LVersionMPUI.Caption:=UTF8Decode('MPUI نسخة:');
  ...
  with OptionsForm do begin
    ...
    LHelp.Caption:=UTF8Decode('مساعدة');
  end;
